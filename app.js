...
{id:'C058',idc:'C058',nombre:'PESO_MENSUAL_SUMATORIA',claveOriginal:'PESO%_MES_SUMATORIA',label:'Peso % mensual (sumatoria)',categoria:'Parámetros de tiempo',nominal:null,esSupuesto:true,formula:'(MES%_1+MES%_2+MES%_3+MES%_4+MES%_5+MES%_6+MES%_7+MES%_8+MES%_9+MES%_10+MES%_11+MES%_12)',estado:'Activo',driver:'—',moneda:'SOLES',rent:'Computada',history:[]},
